...
def insertionsort():
	...
	length = 600
	array = [0] * 151
	arr_clr = [(0, 197, 204)] * 151
	clr_ind = 0
	clr = [(0, 204, 102), (184, 15, 74),
		   (0, 153, 99), (255, 255, 255)]
	...
	def draw():
		...
		txt = fnt.render("Press 'ENTER' to start Sorting", 1, (94, 224, 175))
		# Position where text is placed
		screen.blit(txt, (20, 20))
		txt1 = fnt.render("Press 'R' for New array", 1, (94, 224, 175))
		screen.blit(txt1, (20, 40))
		txt2 = fnt1.render("InsertionSort Sort", 1, (222, 224, 94))
